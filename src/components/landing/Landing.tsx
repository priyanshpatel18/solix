...
import { Database, Rocket, Search, SettingsIcon, ShieldCheck, TrendingUp } from "lucide-react";
        ...
        <div className="lg:flex lg:items-center lg:justify-between">
          <motion.div className="text-center lg:text-left lg:w-1/2" variants={staggerChildren}>
            ...
            <motion.div className="space-x-4" variants={slideUp}>
              <Button asChild size="lg" className="bg-primary text-primary-foreground hover:bg-primary/90 cursor-pointer">
...
function Feature({ icon: Icon, title, description }: { icon: React.ComponentType; title: string; description: string }) {
  return (
